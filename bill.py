...
#===================Python Variables=======================
menu_category = ["Stationery","Books","PenStands","Essentials"]

menu_category_dict = {"Stationery":"1 Stationery.txt","Books":"2 Books.txt",
                "PenStands":"3 Penstands.txt","Essentials":"4 Essentials.txt"}
...
item_rate_label = Label(item_frame2, text="Rate", 
                    font=("arial", 12, "bold"),bg = "lightgreen", fg="blue")
item_rate_label.grid(row=0,column=2,padx=10)
...
clear_button.grid(row=0,column=3,padx=10,pady=30)
